...
export default function Selection({ onButtonPress, children, selected, selectionText, buttonText, setTopPadding: setSelectionTextNLines, enabled = true }: Props) {
    ...
    return (
        <View style={styles.container} >
            {!enabled && (<View style={styles.containerDisabled} />)}
