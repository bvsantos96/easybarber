...
export const SECURE_STORAGE_LOGIN_KEY = "login";
export const LOCATIONS_STORAGE_KEY = "locations";
export const TOKEN_STORAGE_KEY = "token";
export const CATEGORY_STORAGE_KEY = "categories";
export const MOBILE_INFORMATION = "mobileInformation";
export const FIRST_TIME = "firstTime";
export const defaultBarberImage = "https://bucket-barber-staging.s3.eu-south-2.amazonaws.com/image.png";