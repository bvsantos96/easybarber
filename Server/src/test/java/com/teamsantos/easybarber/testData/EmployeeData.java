...
public class EmployeeData {
    ...
    static {
        ...
        employees.add(new UserTestDTO(1L, "+351", "999999999", "Test123*", "Henrique"));
        employees.add(new UserTestDTO(2L, "+351", "900000000", "Test123*", "Amigo do Joao"));
        employees.sort(Comparator.comparing(UserTestDTO::getId));

        employeesEstablishments = new TreeMap<>();
        employeesEstablishments.put(1L, new ArrayList<>());
        employeesEstablishments.get(1L).add(1L);
        employeesEstablishments.get(1L).add(2L);
        employeesEstablishments.put(2L, new ArrayList<>());
        employeesEstablishments.get(2L).add(2L);

        adminEstablishments = new TreeMap<>();
        adminEstablishments.put(1L, new ArrayList<>());
        adminEstablishments.get(1L).add(1L);
        adminEstablishments.put(2L, new ArrayList<>());
        adminEstablishments.get(2L).add(2L);

        employeeImages = new TreeMap<>();
        employeeImages.put(1L, new ArrayList<>() {
            {
